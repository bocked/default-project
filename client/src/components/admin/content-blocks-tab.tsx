...
export function AdminContentBlocksTab() {
                ...
                {block.key === "quote.today" && (
                  <div className="rounded-lg bg-slate-50 p-2.5 text-xs text-slate-600 dark:bg-slate-800 dark:text-slate-300">
                    ...
                    <p className="mt-1 text-slate-400 dark:text-slate-500">
                      Qulay boshqaruv uchun: Admin &rarr; Kontent &rarr; Iqtiboslar bo&apos;limida har bir
                      tasdiqlangan iqtibosga &ldquo;★ Kun iqtibosi qilish&rdquo; tugmasi mavjud. Bo&apos;sh qoldirilsa
                      tizim avtomatik tanlaydi.
                    </p>
                  </div>
                )}
